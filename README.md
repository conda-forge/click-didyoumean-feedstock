...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-didyoumean-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9315&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-didyoumean-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-didyoumean` can be installed with:

```
conda install click-didyoumean
```

It is possible to list all of the versions of `click-didyoumean` available on your platform with:
